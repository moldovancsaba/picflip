  ...
  return (
    <Container>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        {/* 4. Organisation Assignment Section */}
        <Section>
          <SectionTitle>Organisation Assignment</SectionTitle>
          
          {/* Current Organization Display */}
          {project.currentOrganisation ? (
            <FormGroup>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontWeight: 500 }}>{project.currentOrganisation.name}</div>
                  <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>/{project.currentOrganisation.slug}</div>
                  {project.currentOrganisation.description && (
                ...
                <Button
                  type="button"
                  onClick={() => setProject({ ...project, organisationId: null })}
          ...
          <FormGroup>
            <Label htmlFor="organisationId">Assign to Organization</Label>
            <Select
              id="organisationId"
              value={project.organisationId || ''}
              onChange={(e) =>
                setProject({ ...project, organisationId: e.target.value || null })
              }
            >
          ...
          <FormGroup>
            ...
            <div style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#6b7280' }}>
              {project.isPublic 
                ...
                : 'This project is only visible to you and organisation members'
              }
            </div>
          </FormGroup>
        </Section>
